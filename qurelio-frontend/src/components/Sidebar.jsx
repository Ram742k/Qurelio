  ...
  return (
    <aside style={{
      ...
      <div style={{
        ...
        <div>
          <h1 style={{ fontSize: '18px', fontWeight: '800', color: '#0f172a', letterSpacing: '-0.03em', lineHeight: 1.1 }}>
            {tenant?.name || 'CliniCare'}
          </h1>
          <span style={{ fontSize: '11px', color: '#0d9488', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
            Qurelio Health
          </span>
        </div>
      </div>
